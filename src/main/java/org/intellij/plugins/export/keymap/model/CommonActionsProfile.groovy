...
independently of current imports)'''),
            ...
            new Header(depth: 0, name: 'Cursive'),
            new ActionData(id: [':plugin.actions.paredit/backward']),
            new ActionData(id: [':plugin.actions.paredit/forward']),
            new ActionData(id: [':plugin.actions.paredit/barf-backwards']),
            new ActionData(id: [':plugin.actions.paredit/barf-forwards']),
            new ActionData(id: [':plugin.actions.paredit/close-curly-and-newline']),
            new ActionData(id: [':plugin.actions.paredit/close-paren-and-newline']),
            new ActionData(id: [':plugin.actions.paredit/close-square-and-newline']),
            new ActionData(id: [':plugin.actions.paredit/join']),
            new ActionData(id: [':plugin.actions.paredit/kill']),
            new ActionData(id: [':plugin.actions.paredit/raise']),
            new ActionData(id: [':plugin.actions.paredit/slurp-backwards']),
            new ActionData(id: [':plugin.actions.paredit/slurp-forwards']),
            new ActionData(id: [':plugin.actions.paredit/splice']),
            new ActionData(id: [':plugin.actions.paredit/split']),
            new ActionData(id: [':plugin.actions.paredit/toggle']),
            new ActionData(id: [':plugin.actions.paredit/wrap-curly']),
            new ActionData(id: [':plugin.actions.paredit/wrap-paren']),
            new ActionData(id: [':plugin.actions.paredit/wrap-quotes']),
            new ActionData(id: [':plugin.actions.paredit/wrap-square']),
            new ActionData(id: [':plugin.repl.actions/load-file'])
